"""
Django settings for third_part_project project.
...
SECRET_KEY = 'gw-*t-(eg9geqt6+va$l11-$mu(nm&u&b96^(0@nog--gnm+$3'
...
WSGI_APPLICATION = 'third_part_project.wsgi.application'
